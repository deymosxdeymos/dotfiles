...
-- Some servers (e.g. Tailwind CSS) produce huge completion lists; keep them manual to avoid lag.
local manual_completion_clients = {
    tailwindcss = true,
}
...
vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(args)
        ...
        if client:supports_method('textDocument/completion') then
            local autotrigger = not manual_completion_clients[client.name]
...
vim.keymap.set("n", "<leader>pc", _G.pack_clean)
