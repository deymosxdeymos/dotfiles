return {
  ...
  config = function()
    ...
    -- vim.keymap.set("n", "<C-n>", function() harpoon:list():prev() end, { desc = "Previous harpoon file" })
    -- vim.keymap.set("n", "<C-p>", function() harpoon:list():next() end, { desc = "Next harpoon file" })
  end,
}
